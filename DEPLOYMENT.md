...
| `SENTRY_DSN` | Optional | Server-side error tracking. Create a Node.js project in Sentry and add its DSN in the hosting dashboard. Leave blank to disable Sentry. |
